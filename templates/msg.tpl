...
<div class="row" style="margin-top:5px;">
	<div class="col-md-10 col-md-push-1">
		<div class="alert alert-success text-center">We have {$faucet_balance} gwei available!</div>
	</div>
</div>
...
<div class="row" style="margin-top:5px;">
	<div class="col-md-10 col-md-push-1">
		<div class="alert alert-success text-center">
			<strong>{$succ}</strong> gwei was sent to <strong><a href="https://epay.info/check/{$wallet}" target="_blank" style="color:#464646"> your ePay.info account</a></strong>
		</div>
	</div>
</div>
{/if}
